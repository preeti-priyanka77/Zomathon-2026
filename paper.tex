...
\title{SmartCart v2.0: A Context-Aware, Low-Latency Learning-to-Rank System\\
for Real-Time Add-On Recommendation in Food Delivery}

\author{
  \IEEEauthorblockN{SmartCart Team}
  \IEEEauthorblockA{
...
% ── Abstract ──────────────────────────────────────────────────────────────────
\begin{abstract}
We present \textbf{SmartCart v2.0}, a production-ready, context-aware
...
SmartCart v2.0 addresses these challenges through a carefully designed
...
\begin{algorithm}
\caption{SmartCart v2.0 Inference Pipeline}
\begin{algorithmic}[1]
...
\begin{tabular}{lrrr}
\toprule
Metric & Baseline & SmartCart v2.0 & Lift \\
\midrule
AUC            & ---    & \textbf{0.9700} & --- \\
...
\begin{itemize}
  ...
  \item \textbf{Treatment (50\%)}: SmartCart v2.0 personalised recommendations
\end{itemize}
...
dynamically as items are added or removed from the cart. SmartCart v2.0
...
We presented SmartCart v2.0, a production-ready, context-aware add-on
